...
public class LimelightHelperFunctions {
    ...
    public static Optional<LimelightFiducial> getLatestFiducialTarget(String limeLightName, String fiducialFamily, double fiducialID) {
        //16H5C - April Tag
    ...
    public static Optional<LimelightDetector> getLatestDetectorTarget(String limeLightName) {
        LimelightResults results = getLatestResults(limeLightName);
